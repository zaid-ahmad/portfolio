                ...
                <div className='flex flex-col md:mt-32'>
                    ...
                    <div className='flex flex-col text-xl'>
                        ...
                        <p className='leading-[160%]'>
                            ...
                            and a full stack developer with a passion for
                            creating scalable value-induced applications that
                            help people.
                        </p>
                        <br />
                        <p className='leading-[160%]'>
                            ...
                            team player and I am always learning something new.
                        </p>
                        <br />
                        <p className='leading-[160%]'>
                            Open source is awesome and I have contributed to
                            several open source projects, and I am always
