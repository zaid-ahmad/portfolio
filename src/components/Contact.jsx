        ...
        <div className='flex flex-col h-screen '>
          ...
          <div className='container flex flex-col items-center justify-center w-screen gap-5 mt-10'>
            <form
              ref={form}
              onSubmit={sendEmail}
              className='border-4 rounded-md border-[#ebebeb73] md:px-14 py-5 px-10 w-screen md:w-auto'
            >
              <p className='text-xl font-light pb-7'>Send me message!</p>
              ...
              <div className='flex flex-col mt-3'>
                <label className='font-light uppercase'>Message</label>
                <textarea
                  name='message'
