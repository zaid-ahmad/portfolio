        ...
        <>
            ...
            >
                <div className='flex flex-col h-screen'>
                    <h2 className='font-lalezar text-6xl md:ml-0 ml-6'>
                        Contact
                    </h2>
                    <div className='container flex flex-col items-center justify-center w-screen gap-5 mt-10 '>
                        <form
                            ref={form}
                            onSubmit={sendEmail}
                            className='border-4 rounded-md border-[#ebebeb73] md:px-14 py-5 px-10 w-screen md:w-full'
                        >
                            <p className='text-xl font-light pb-7'>
                                Send me a message!
                            </p>
                            ...
                            <div className='flex flex-col gap-2'>
                                <input
                                    type='submit'
                                    value='Send'
                                    className='bg-[#FDCB6E] cursor-pointer hover:bg-[#ebac37] transition text-black py-1 px-8 rounded-md font-medium mt-5'
                                />
                                {message &&
                        ...
                        <div className='flex items-center gap-7 w-full mt-5'>
                            <a
                                href='https://github.com/zaid-ahmad'
                                target='_blank'
                                className='hover:border-gray-300 border-b-2 border-transparent transition'
                            >
                            ...
                            <a
                                href='https://twitter.com/zaidahmad__dev'
                                target='_blank'
                                className='hover:border-gray-300 border-b-2 border-transparent transition'
                            >
                                <div className='flex flex-col md:flex-row items-center md:gap-3'>
                            ...
                            <a
                                href='mailto:zaidd250@gmail.com'
                                className='hover:border-gray-300 border-b-2 border-transparent transition'
                            >
                                <div className='flex flex-col md:flex-row items-center md:gap-3'>
                                    <img
            ...
            <p className='text-white font-extralight pb-5'>
